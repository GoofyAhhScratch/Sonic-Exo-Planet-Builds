...
if (global.player_rings >= 20 && StarpostType == "Normal")
{
    for (var i = 0; i < 4; i++)
    {
...
else if (global.player_rings >= 0 && StarpostType == "Past")
 {
    for (var i = 0; i < 4; i++)
    {
        instance_create(x, y - 50, obj_starpost_star_past, { StarID: i, ParentStarPost: id });
    }
}
else if (global.player_rings >= 0 && StarpostType == "Future")
    for (var i = 0; i < 4; i++)
    {
        instance_create(x, y - 50, obj_starpost_star_past, { StarID: i, ParentStarPost: id });
    }